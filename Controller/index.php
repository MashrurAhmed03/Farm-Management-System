...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">BuyBest &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Buy Best Fam<span>Vormir</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About BuyBest</b></span>
				AgroCulture is e-commerce trading platform for grains, farm-animals & grocerries...
			</p>
			<div class="footer-icons">
				<a  href="http://www.facebook.com"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
				<a href="http://www.instagram.com"><i style="margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
				<a href="http://www.youtube.com"><i style="margin-left: 0;margin-top:5px" class="fa fa-youtube"></i></a>
			</div>
		</div>
